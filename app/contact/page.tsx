    ...
    <section className="bg-background relative w-full overflow-hidden py-16 md:py-24">
      ...
      >
        <Link href="/" className="group flex items-center gap-2">
          ...
          {/* Option 2: If you have an actual logo image, use this instead: */}
          {/* 
          ...
          <div className="grid md:grid-cols-2">
            ...
            >
              <div className="flex flex-col items-center justify-center overflow-hidden">
                <article className="relative mx-auto h-[350px] min-h-60 max-w-[450px] overflow-hidden rounded-3xl border border-neutral-800/50
 bg-gradient-to-b from-[#e60a64] to-[#e60a64]/5 p-6 text-3xl tracking-tight text-white md:h-[450px] md:min-h-80 md:p-8 md:text-4xl md:leading-[1.05] lg:text-5xl">
